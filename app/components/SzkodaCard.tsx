...
const SzkodaCard = ({ claim, onDetailsClick }: SzkodaCardProps) => {
  return (
    <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 hover:shadow-lg transition-shadow flex flex-col justify-between">
      <div>
        {/* Card Header */}
      ...
      <div className="mt-6 text-right">
        <button onClick={onDetailsClick} className="font-medium text-blue-600 hover:text-blue-800">
          Zobacz szczegóły →
        </button>
      </div>
    </div>
